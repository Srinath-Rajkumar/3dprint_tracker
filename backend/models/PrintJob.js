...
//     project: { type: mongoose.Schema.Types.ObjectId, ref: 'Project', required: true }, // For easier querying
//     machinePlateNo: { type: String }, // Optional
//     machine: { type: mongoose.Schema.Types.ObjectId, ref: 'Printer', required: true },
//     printTimeScheduledSeconds: { type: Number, required: true }, // Store in seconds: days*24*3600 + hrs*3600 + mins*60
//     weightGrams: { type: Number, required: true }, // Store in grams
    
//     jobStartDate: { type: Date, default: Date.now },
//     jobStartTime: { type: String }, // e.g., "8:00pm" - could also be derived from jobStartDate
    
//     status: { type: String, enum: ['printing', 'completed', 'failed'], default: 'printing' },
    
//     // If failed and reprinted
//     isReprint: { type: Boolean, default: false },
//     originalFailedJob: { type: mongoose.Schema.Types.ObjectId, ref: 'PrintJob', default: null }, // Link to the job that failed
    
//     // Actuals (updated on completion/failure)
//     actualPrintTimeSeconds: { type: Number },
//     actualEndTime: { type: Date },
//     failReason: { type: String }, // If status is 'failed'
